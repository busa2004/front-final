...
import { Button, message, Input, Select, Checkbox } from 'antd';
...
import Selecter from './selecter2'
            ...
            <div>
                ...
                {this.state.router === 'report' ?
                    <div className="information" >
                            ...
                            <Selecter textEdit={true} onUserTaskChange={this.onUserTaskChange} userTask={this.state.userTask} />
                ...
                {this.state.router === 'report' ?
                <div>
                 <Checkbox onChange={this.checkboxOnChange}>보고서 공개</Checkbox>
                 <p></p>
